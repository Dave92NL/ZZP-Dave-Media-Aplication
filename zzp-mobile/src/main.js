...
import { initAppUpdates } from './lib/appUpdate.js';
...
import * as exportPage from './pages/exportData.js';
...
// Aktualizacje PWA: pasek „Nowa wersja — Odśwież" (automatyczny check co godzinę)
// + funkcja ręcznego sprawdzenia użyta przez przycisk w „Więcej" (more.js).
initAppUpdates();
